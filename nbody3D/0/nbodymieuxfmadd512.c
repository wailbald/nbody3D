...
void move_particles(particle_t *p, f32 dt, u64 n)
{
  ...
  __m512 x1, y1, z1, x2, y2, z2, vx, vy, vz;
  __m512 dx, dy, dz, dx2, dy2, dz2, sof, tmp;
  __m512 fx, fy, fz, d_2, d_3_over_2, mdt;
...
int main(int argc, char **argv)
{
  ...
  p->x = aligned_alloc(64,sizeof(f32) * (n+15));
  p->y = aligned_alloc(64,sizeof(f32) * (n+15));
  p->z = aligned_alloc(64,sizeof(f32) * (n+15));

  p->vx = aligned_alloc(64,sizeof(f32) * (n+15));
  p->vy = aligned_alloc(64,sizeof(f32) * (n+15));
  p->vz = aligned_alloc(64,sizeof(f32) * (n+15));
